...
- azure-mysql
urlFragment: azure-fastapi-mysql-flexible-aca
name: Deploy FastAPI Application with MySQL on Azure Container Apps (Python)
...
# Deploy FastAPI Application with MySQL via Azure Container Apps
